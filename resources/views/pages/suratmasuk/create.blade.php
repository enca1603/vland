...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('surat.suratmasuk.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row g-6">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <x-vinput label="Tgl. Terima Surat" name="tgl_terima"></x-vinput>
                </div>
                <div class="col-md-6">
                    <x-vinput label="Pengirim" name="pengirim"></x-vinput>
                </div>
                <div class="col-md-6">
