<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-header small">
            <span class="menu-header-text" data-i18n="Apps &amp; Mail Transaction">Transaksi Surat</span>
        </li>
        ...
        <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('klasifikasi.index') ? 'active' : '' }}">
